...
from flowgen.pipelines.pipeline_flow_gen_controlnet_baseline import FlowGenPipeline
...
class Drag:
    ...
    def run(
        ...
        kernel_size = 2  # You can adjust this size based on how much dilation you want
...
run_for_multiple_images('frame_data.json', 'results/baselines/controlnet/outputs', num_gens)
