...
class Drag:
    def __init__(
        ...
        vae_img = AutoencoderKL.from_pretrained(
            "/DATA/soham/preet/data/Motionmodes/Motion-I2V/models/stage2/StableDiffusion", subfolder="vae"
        )
        import json

        with open("/DATA/soham/preet/data/Motionmodes/Motion-I2V/models/stage1/StableDiffusion-FlowGen/vae/config.json", "r") as f:
            vae_config = json.load(f)
        vae = AutoencoderKL.from_config(vae_config)
        vae_pretrained_path = (
            "/DATA/soham/preet/data/Motionmodes/Motion-I2V/models/stage1/StableDiffusion-FlowGen/vae_flow/diffusion_pytorch_model.bin"
        )
        ...
        unet_pretrained_path = (
            "/DATA/soham/preet/data/Motionmodes/Motion-I2V/models/stage1/StableDiffusion-FlowGen/unet/diffusion_pytorch_model.bin"
        )
        ...
        controlnet_pretrained_path = (
            "/DATA/soham/preet/data/Motionmodes/Motion-I2V/models/stage1/StableDiffusion-FlowGen/controlnet/controlnet.bin"
        )
    ...
    def setup_animate_pipeline(self):
        ...
        pretrained_model_path = "/DATA/soham/preet/data/Motionmodes/Motion-I2V/models/stage2/StableDiffusion"
        print("start loading")
        tokenizer = CLIPTokenizer.from_pretrained(
            pretrained_model_path, subfolder="tokenizer"
        )
        ...
        # 3. text_model
        motion_module_path = "/DATA/soham/preet/data/Motionmodes/Motion-I2V/models/stage2/Motion_Module/motion_block.bin"
        ...
        with safe_open(
            "/DATA/soham/preet/data/Motionmodes/Motion-I2V/models/stage2/DreamBooth_LoRA/realisticVisionV51_v20Novae.safetensors",
            framework="pt",
            device="cpu",
        ) as f:
            for key in f.keys():
        ...
        personalized_unet_path = "/DATA/soham/preet/data/Motionmodes/Motion-I2V/models/stage2/DreamBooth_LoRA/realistic_unet.ckpt"
...
def process_images(frame_path, mask_path, prompt, output_dir):
    ...
    drag_nuwa = Drag(
        "cuda:0",
        "/DATA/soham/preet/data/Motionmodes/Motion-I2V/models/stage1/StableDiffusion-FlowGen",
